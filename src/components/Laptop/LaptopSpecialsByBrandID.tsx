...
const LaptopSpecialsByBrandID = (props: any) => {
  let brandId = props.CtrlId;
  let sort = props.Sort;
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const pdatas = await ProductAPI.getLaptopDealsByBrandId({ brandId });
...
export default LaptopSpecialsByBrandID;
