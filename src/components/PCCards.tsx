...
const PCCards = (props: any) => {
  ...
  let FPSData: any = {};
  let FilteredGame: any = props.filterdGame;
      ...
      <div className={classes.product_card}>
        ...
        >
          ...
          >
            <Card.Img
              variant=""
              className={`p-1 pb-4 bg-white ${classes.CardPic}`}
            ...
            Performance.timeSpyScoreGPU !== undefined ? (
              <section className="position-relative overflow-hidden rounded-bottom">
                <div className="position-absolute w-100 h-100">
                  <Image src={gameImg} className="w-100 img-cover" alt="" />
                </div>
            ...
            >
              ...
              <div className="">
                ...
                >
                  ...
                  {/* Circles */}
                  <section
                    className={`${styles.Circles} position-relative d-flex gap-sm-2 flex-wrap justify-content-center px-2`}
                  >
                    {/* {isHD ? "HD" : "No HD"} */}
                    <div
                      className={`${
                    ...
                    >
                      <span
                        className={`
                          ...
                          text-white bg-black px-1 py-0 rounded-pill w-75 text-center
                        `}
                      >
                        1440p
                      </span>
              ...
              <div
                className={`${
                  darkMode ? `border-0 bg-opacity-75` : `bg-opacity-25`
                } bg-secondary px-2 px-sm-3 py-1 border d-flex align-items-center justify-content-center lh-1`}
              >
                <small>
                  <small>
