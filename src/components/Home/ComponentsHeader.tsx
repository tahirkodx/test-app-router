...
function ComponentsHeader(props: any) {
  ...
  return (
    <>
      <Navbar
        bg="light"
        expand="xl"
        className={`${styles.NavBar} ${styles.Component} px-0 py-0 text-light`}
      >
        {!isBig && (
        ...
        <Navbar.Collapse
          ...
          style={{ backgroundColor: isDarkMode ? `#171717` : `` }}
        >
                      ...
                      >
                        {
                          <div style={{ display: "inline-block" }}>
                            ...
                            Section.logo.trim().length > 0 ? (
                              <Image
                                src={
                                  isDarkMode ? Section.logoDark : Section.logo
                                }
                                alt={Section.title}
                              ...
                              >
                                <div className="py-3 rounded">
                                  <Image
                                    ...
                                    className="object-contain w-100 h-100 section"
                                    style={{ maxHeight: "20px" }}
                                  />
                                </div>
                                {isBig && (
                          ...
                          >
                            ...
                            Section.logo.trim().length > 0 ? (
                              <Image
                                ...
                                height={Section.logoHeight}
                                alt={Section.title}
                                className="small logos object-contain w-100 h-100"
                                style={{ maxHeight: "20px" }}
                              />
                            ) : (
