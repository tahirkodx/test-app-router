...
const ComponentsByCID = (props: any) => {
  ...
  const [categoryCards, setCategoryCards] = useState<any>(null);
  ...
  useEffect(() => {
    ...
    if (props !== undefined && props.cid !== null && props.cid !== undefined) {
      setPageCid(props.cid);
    }
  }, [props]);
        ...
        >
          <Stack className="pt-3 pb-4 gap-2 gap-md-3">
            ...
            <section>
              ...
              >
                {pageCid !== 0 && isSet && categoryCards !== null
                  ? categoryCards
                  : null}
              </Col>
            </section>
                ...
                >
                  ...
                  >
                    <div className="comp-bottom-section">
                      {HTMLReactParser(compBottomBanners)}
                      {/* formatHTMLImg() */}
                    </div>
                  </Col>
                </section>
...
export default ComponentsByCID;
