    ...
    <>
      {component !== undefined && (
        <Head>
          ...
          <meta
            name="description"
            content={component.ProductMetaDescription}
          ></meta>
          <meta property="og:locale" content="en_ZA"></meta>
          ...
          <meta
            property="og:image"
            content={
              component.MainImage ? component.MainImage : component.ProductImage
            }
          ></meta>
          ...
          <meta
            ...
            content={`${currencyFormat(component.Price_Vat)} inc. VAT`}
          ></meta>
          <meta property="twitter:label2" content="Availibility"></meta>
          <meta
            property="twitter:data2"
            content={component.Availability}
          ></meta>
          <meta property="product:brand" content={component.Brand}></meta>
          <meta
            property="product:price:amount"
            content={priceFormat(component.Price_Vat)}
          ></meta>
