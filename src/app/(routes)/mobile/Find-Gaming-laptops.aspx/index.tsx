    ...
    <>
      <Helmet>
        <title itemProp="name" lang="en">
          Find your Gaming Laptop - FPS Laptop Gaming
        </title>
        <meta
          name="description"
          content="Find the perfect gaming laptop, choose your game and FPS and get the gaming laptop of your dreams"
        ></meta>
      </Helmet>
        ...
        {activeTab === "resolutions" && (
          <Stack gap={2} className="mb-5 position-relative z-index-1">
            ...
            >
              <div className="w-100">
                <Link
                  href={`/find-gaming-laptops-by-fps/${selectData.gameTitle}/1080p`}
                  ...
                  onClick={() => {
                    ...
                    router.push(
                      `/find-gaming-laptops-by-fps/${selectData.gameTitle}/1080p`
                    );
                  }}
                >
              ...
              <Link
                href={`/find-gaming-laptops-by-fps/${selectData.gameTitle}/1440p`}
                ...
                onClick={() => {
                  ...
                  router.push(
                    `/find-gaming-laptops-by-fps/${selectData.gameTitle}/1440p`
                  );
                }}
              >
                <div className="d-flex flex-column justify-content-center align-items-center rounded-circle bg-dark text-light text-center w-100 h-100 gap-1">
              ...
              <Link
                href={`/find-gaming-laptops-by-fps/${selectData.gameTitle}/4k`}
                className={`${styles.SmallFPS} ${styles.FPS} p-1 rounded-circle bg-light text-decoration-none d-inline-block hover-grow-3`}
                onClick={() => {
                  setSelectedData((prevData) => {
                    prevData.gameFPS = "4k";
                  ...
                  router.push(
                    `/find-gaming-laptops-by-fps/${selectData.gameTitle}/4k`
                  );
                }}
              >
                <div className="d-flex flex-column justify-content-center align-items-center rounded-circle bg-dark text-light text-center w-100 h-100 gap-1">
...
export default FindGamingLaptops;
